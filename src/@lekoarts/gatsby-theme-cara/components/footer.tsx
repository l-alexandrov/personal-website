...
const Footer = () => {
  ...
  const { author: twitterHandle } = useSiteMetadata();
  ...
  return (
    <Box as="footer" variant="footer">
      ...
      >
        ...
        />
        <SocialIcon
          url={`https://github.com/l-alexandrov`}
          {...iconsAttributes}
        />
        <SocialIcon
          url={`https://linkedin.com/in/l-alexandrov`}
          {...iconsAttributes}
        />
        <SocialIcon
          url={`mailto:luboslavaleksandrov@gmail.com`}
          {...{
            ...iconsAttributes,
            ...{
              style: {
